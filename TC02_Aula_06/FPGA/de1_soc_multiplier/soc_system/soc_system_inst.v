	soc_system u0 (
		.avmm_to_wishbone_bridge_0_wishbone_writeresponsevalid_n (<connected-to-avmm_to_wishbone_bridge_0_wishbone_writeresponsevalid_n>), // avmm_to_wishbone_bridge_0_wishbone.writeresponsevalid_n
		.avmm_to_wishbone_bridge_0_wishbone_beginbursttransfer   (<connected-to-avmm_to_wishbone_bridge_0_wishbone_beginbursttransfer>),   //                                   .beginbursttransfer
		...
		.testeram_clk2_clk                                       (<connected-to-testeram_clk2_clk>),                                       //                      testeram_clk2.clk
		.testeram_reset2_reset                                   (<connected-to-testeram_reset2_reset>),                                   //                    testeram_reset2.reset
		.testeram_s2_address                                     (<connected-to-testeram_s2_address>),                                     //                        testeram_s2.address
		.testeram_s2_chipselect                                  (<connected-to-testeram_s2_chipselect>),                                  //                                   .chipselect
		.testeram_s2_clken                                       (<connected-to-testeram_s2_clken>),                                       //                                   .clken
		.testeram_s2_write                                       (<connected-to-testeram_s2_write>),                                       //                                   .write
		.testeram_s2_readdata                                    (<connected-to-testeram_s2_readdata>),                                    //                                   .readdata
		.testeram_s2_writedata                                   (<connected-to-testeram_s2_writedata>),                                   //                                   .writedata
		.testeram_s2_byteenable                                  (<connected-to-testeram_s2_byteenable>)                                   //                                   .byteenable
	);
