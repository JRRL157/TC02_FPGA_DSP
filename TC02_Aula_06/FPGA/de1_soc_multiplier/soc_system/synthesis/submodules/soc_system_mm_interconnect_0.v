...
module soc_system_mm_interconnect_0 (
	...
	wire  [131:0] testeram_s1_agent_rf_source_data;                                                   // testeRam_s1_agent:rf_source_data -> testeRam_s1_agent_rsp_fifo:in_data
	...
	wire  [131:0] testeram_s1_agent_rsp_fifo_out_data;                                                // testeRam_s1_agent_rsp_fifo:out_data -> testeRam_s1_agent:rf_sink_data
	...
	wire          testeram_s1_agent_rp_valid;                                                         // testeRam_s1_agent:rp_valid -> router_012:sink_valid
	wire  [130:0] testeram_s1_agent_rp_data;                                                          // testeRam_s1_agent:rp_data -> router_012:sink_data
	wire          testeram_s1_agent_rp_ready;                                                         // router_012:sink_ready -> testeRam_s1_agent:rp_ready
	wire          testeram_s1_agent_rp_startofpacket;                                                 // testeRam_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          testeram_s1_agent_rp_endofpacket;                                                   // testeRam_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> testeRam_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> testeRam_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // testeRam_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> testeRam_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> testeRam_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> testeRam_s1_burst_adapter:sink0_endofpacket
	wire          testeram_s1_burst_adapter_source0_valid;                                            // testeRam_s1_burst_adapter:source0_valid -> testeRam_s1_agent:cp_valid
	wire  [130:0] testeram_s1_burst_adapter_source0_data;                                             // testeRam_s1_burst_adapter:source0_data -> testeRam_s1_agent:cp_data
	wire          testeram_s1_burst_adapter_source0_ready;                                            // testeRam_s1_agent:cp_ready -> testeRam_s1_burst_adapter:source0_ready
	wire    [7:0] testeram_s1_burst_adapter_source0_channel;                                          // testeRam_s1_burst_adapter:source0_channel -> testeRam_s1_agent:cp_channel
	...
	wire          testeram_s1_agent_rdata_fifo_out_valid;                                             // testeRam_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] testeram_s1_agent_rdata_fifo_out_data;                                              // testeRam_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          testeram_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_007:in_0_ready -> testeRam_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> testeRam_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> testeRam_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // testeRam_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> testeRam_s1_agent:rdata_fifo_sink_error
