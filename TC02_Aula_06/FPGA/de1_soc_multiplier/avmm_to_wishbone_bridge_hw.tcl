...
set_module_property GROUP LAB_PDS
set_module_property AUTHOR jrrl
...
set_interface_property avmm associatedClock ""
set_interface_property avmm associatedReset ""
...
add_interface_port wishbone adr_o writeresponsevalid_n Output BUS_WIDTH
add_interface_port wishbone data_i beginbursttransfer Input DATA_WIDTH
add_interface_port wishbone data_o writeresponsevalid_n Output DATA_WIDTH
add_interface_port wishbone we_o writeresponsevalid_n Output 1
add_interface_port wishbone sel_o writeresponsevalid_n Output BE_WIDTH
add_interface_port wishbone stb_o writeresponsevalid_n Output 1
add_interface_port wishbone ack_i beginbursttransfer Input 1
